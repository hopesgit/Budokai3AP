...
def get_rich_item_name(ctx: 'Budokai3Context', net_item: NetworkItem, player_name_after: bool = False) -> str:
...
def get_rich_item_name_from_location(ctx: 'Budokai3Context', location_id: int) -> str:
