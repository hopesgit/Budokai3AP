...
def handle_received_collectables(ctx: 'Budokai3Context', current_items: dict[str, int]):
    for item in Items.COLLECTABLES:
        item_id = Budokai3World.item_name_to_id[item.name]
...
def resync_problem_items(ctx: 'Budokai3Context'):
    # Clank
