...
class Vendor:
    ...
    def change_mode(self, ctx: "Budokai3Context", new_mode: Mode):
    ...
    def refresh(self, ctx: "Budokai3Context") -> None:
        try:
    ...
    def _reset_weapon_data(self, ctx: "Budokai3Context") -> None:
...
def planet_by_id(planet_id) -> Optional[Budokai3Planet]:
    for world in Budokai3Planet:
...
class Budokai3Interface:
    ...
    def unlock_planet(self, planet_number: int):
        ...
        if Budokai3Planet.Ship_Shack not in planet_list:
            planet_list.insert(0, Budokai3Planet.Ship_Shack)
    ...
    def switch_planet(self, new_planet: Budokai3Planet) -> bool:
    ...
    def get_current_planet(self) -> Budokai3Planet:
